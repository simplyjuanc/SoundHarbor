...
// TODO although implemented properly, this is currently not necessary as the app is using a personal token to access only a single account
...
export const GET = async (req: NextRequest) => {
  ...
  cookies().set('discogs_token_secret', oauth_token_secret, {
    expires: new Date(Date.now() + oneDay),
  });
  redirect('/dashboard');
};
